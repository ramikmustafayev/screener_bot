...
tickers_to_exclude = {
    ...
    'ONDOUSDT','MAJORUSDT','MORPHOUSDT','JSTUSDT','DLCUSDT','RPLUSDT','KCALUSDT','SALDUSDT','BRAWLUSDT',

    'TRCUSDT','BBLUSDT','SONUSDT','EXVGUSDT','APTRUSDT','AFGUSDT','NLKUSDT','TENETUSDT','PBUXUSDT','RPKUSDT',

    'AARKUSDT','TAPUSDT','ELDAUSDT','AGLAUSDT','THNUSDT','SAILUSDT','KROUSDT','MNRYUSDT','GSTSUSDT','ERTHAUSDT',

    'SMILEUSDT','WELLUSDT','HLGUSDT','AEGUSDT','STARUSDT','WWYUSDT','ELIXUSDT','N3USDT','GALAXISUSDT','VELARUSDT',
